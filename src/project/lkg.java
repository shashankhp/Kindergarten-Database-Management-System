...
public class lkg extends javax.swing.JFrame {
    ...
    public lkg() {
         ...
         try
        {
            ...
            String sql = "select cid, cname, cdob, a_no, caddr from child, admission where K_level='low' and adm_no = a_no ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LKG");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(351, 24, 133, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 96, 759, 355));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(384, 495, -1, -1));
